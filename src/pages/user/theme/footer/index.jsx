...
const Footer = () => {
    return  (
        <footer style={{marginTop: '21px'}} class="w-full">
        <div class="mx-auto max-w-7xl">
          ...
          <div class="grid grid-cols-2 lg:grid-cols-4 2xl:grid-cols-6 gap-8 py-10 ">
            ...
            <div class="lg:mx-auto text-left">
              <h4 class="text-lg text-gray-900 font-medium mb-7"> PVSH Shop</h4>
          ...
          <div class="py-7 border-t border-gray-200">
            <div class="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
              <span class="text-sm text-gray-500 ">©<a href="/">PVSH Shop</a> 2024, All rights reserved.</span>
